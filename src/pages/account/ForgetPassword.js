...
import logo from '../../assets/images/Petra_logo_new.png';
                    ...
                    <div className="home-btn d-none d-sm-block">
                        <Row className="mt-1">
                            <Col className="col-12 text-center">
                                <p className="text-muted">Back to <Link to="/login" className="text-dark ml-1"><b>Sign In    </b></Link><Link to="/login"><i className="fas fa-home h2 text-dark"></i></Link></p>
                            </Col>
                        </Row>
                    </div>
                            ...
                            <Row className="justify-content-center">
                                <Col md={8} lg={6} xl={5} >
                                    <div className="text-center">
                                        <Link to="/">
                                            <span><img src={logo} alt="" height="75" /></span>
                                        </Link>

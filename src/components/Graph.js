...
class Graph extends React.Component {
    ...
    render() {
        return <ChartComponent id="charts" type={BarSeries} primaryXAxis={this.primarxyAxis}
                               legendSettings={this.legendSettings} primaryYAxis={this.primaryyAxis}
                               tooltip={this.tooltip}>
            <Inject services={[ColumnSeries, DataLabel, Tooltip, Legend, BarSeries, Category]}/>
            <SeriesCollectionDirective>
